...
let favoriteFoods = ['pizza', 'ice cream', 'soda'];
...
console.log('The last animal in', animalArray, 'is', lastAnimal);
...
console.log('Favorite foods + dessert:', favoriteFoods);
...
let entree = 'tikka masala';
favoriteFoods.unshift(entree);
console.log('Favorite foods + entree:', favoriteFoods);
